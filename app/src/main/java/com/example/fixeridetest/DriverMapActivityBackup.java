...
public class DriverMapActivityBackup extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
        ...
        CustomerSettingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivityBackup.this, DriverSettingActivity.class);
    ...
    {
        Intent welcomeIntent = new Intent(DriverMapActivityBackup.this,WelcomeActivity.class);
