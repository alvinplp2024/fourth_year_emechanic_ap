...
public class DriverMapActivityBackup1 extends FragmentActivity implements OnMapReadyCallback,
...
// Create a new Places client instance.
       ...
       /* searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
        ...
        CustomerSettingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivityBackup1.this, DriverSettingActivity.class);
    ...
    {
        Intent welcomeIntent = new Intent(DriverMapActivityBackup1.this,WelcomeActivity.class);
