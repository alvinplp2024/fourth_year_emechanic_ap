...
public class DriverMapActivityBackupLatest extends FragmentActivity implements OnMapReadyCallback,
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(requestBol)
                {
                    ...
                    endRide();
                    Intent intent = new Intent(DriverMapActivityBackupLatest.this,Pop.class);
...
*/
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent = new Intent(DriverMapActivityBackupLatest.this,MainActivity.class);
                    startActivity(intent);
                    //return;
        ...
        NearbyPlace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivityBackupLatest.this,MapsActivity.class);
                startActivity(intent);
            }
        });
/*
 ...
 */
        ...
        Dialog customDialog = new Dialog(DriverMapActivityBackupLatest.this);
...
*/
        dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(serviceDesc.getText().toString())){
                    Toast.makeText(DriverMapActivityBackupLatest.this, "Describe your problem ", Toast.LENGTH_SHORT).show();
                    return;
                }
                /*
                int selectId = serviceRadioGroup.getCheckedRadioButtonId();
                ...
                serviceDescRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(DriverMapActivityBackupLatest.this,"Failed to read value",Toast.LENGTH_SHORT).show();
                    }
    ...
    {
        Intent welcomeIntent = new Intent(DriverMapActivityBackupLatest.this,WelcomeActivity.class);
