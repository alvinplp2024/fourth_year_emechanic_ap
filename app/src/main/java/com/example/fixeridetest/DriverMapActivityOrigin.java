...
public class DriverMapActivityOrigin extends FragmentActivity implements OnMapReadyCallback,
...
CancelRequest.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        endRide();
        Intent intent = new Intent(DriverMapActivityOrigin.this,Pop.class);
...
*/
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriverMapActivityOrigin.this,MainActivity.class);
                startActivity(intent);
                //return;
        ...
        NearbyPlace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivityOrigin.this,MapsActivity.class);
                startActivity(intent);
            }
        });
/*
 ...
 */
        ...
        Dialog customDialog = new Dialog(DriverMapActivityOrigin.this);
        ...
        dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(serviceDesc.getText().toString())){
                    Toast.makeText(DriverMapActivityOrigin.this, "Describe your problem ", Toast.LENGTH_SHORT).show();
                    return;
                }
                /*
                int selectId = serviceRadioGroup.getCheckedRadioButtonId();
                ...
                serviceDescRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(DriverMapActivityOrigin.this,"Failed to read value",Toast.LENGTH_SHORT).show();
                    }
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(DriverMapActivityOrigin.this,WelcomeActivity.class);
