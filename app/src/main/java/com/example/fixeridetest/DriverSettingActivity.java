...
public class DriverSettingActivity extends AppCompatActivity {
    ...
    private EditText CustomerNameField,CustomerPhoneField,CustomerVehicleField,CustomerRegistrationNumberField,CustomerEmailEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomerEmailEdit = (EditText) findViewById(R.id.customer_email11);
        ...
        CustomerDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0)
                {
                    ...
                    {
                        CustomerEmail = map.get("email").toString();
                        CustomerEmailEdit.setText(CustomerEmail);
                    }
