...
import com.example.fixeridetest.historyRecyclerView.HistoryAdapter;
import com.example.fixeridetest.historyRecyclerView.HistoryObject;
                    ...
                    */
                    ...
                    if(dataSnapshot.child("customerPaid")!=null && dataSnapshot.child("driverPaidOut").getValue() == null){
                        if(dataSnapshot.child("jarak").getValue()!=null){
                            ...
                            Balance += ridePrice;
                            mBalance.setText("Balance : Kshs "+ String.valueOf(Balance));
                        }
                    }
