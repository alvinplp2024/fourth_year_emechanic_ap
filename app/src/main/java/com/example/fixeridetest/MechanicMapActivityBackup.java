...
public class MechanicMapActivityBackup extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MechanicMapActivityBackup.this, MechanicSettingActivity.class);
    ...
    */
    ...
    {
        Intent welcomeIntent = new Intent(MechanicMapActivityBackup.this,WelcomeActivity.class);
