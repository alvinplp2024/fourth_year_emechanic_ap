...
public class MechanicMapActivityBackupLatest extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MechanicMapActivityBackupLatest.this, MechanicSettingActivity.class);
        ...
        mHistoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intenthistory = new Intent(MechanicMapActivityBackupLatest.this, HistoryActivity.class);
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(MechanicMapActivityBackupLatest.this,WelcomeActivity.class);
