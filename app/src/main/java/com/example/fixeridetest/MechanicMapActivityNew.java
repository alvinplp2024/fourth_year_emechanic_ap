...
public class MechanicMapActivityNew extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanic_map_new);
        ...
        AvailableServiceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MechanicMapActivityNew.this, TestActivity.class);
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MechanicMapActivityNew.this, MechanicSettingActivity.class);
                startActivity(intent);
                return;
            }
        });
        mHistoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intenthistory = new Intent(MechanicMapActivityNew.this, HistoryActivity.class);
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(MechanicMapActivityNew.this,WelcomeActivity.class);
