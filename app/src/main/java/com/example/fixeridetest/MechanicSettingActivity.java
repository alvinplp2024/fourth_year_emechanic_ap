...
public class MechanicSettingActivity extends AppCompatActivity {
    private EditText DriverNameField,DriverPhoneField,DriverCarField,DriverRegistrationNumberField,DriverEmailEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanic_setting);
      ...
      //  DriverRadioGroup = (RadioGroup) findViewById(R.id.radioGroup);
        DriverEmailEdit = (EditText) findViewById(R.id.driver_email11);
        ...
        DriverDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0)
                {
                    ...
                    {
                        DriverEmail = map.get("email").toString();
                        DriverEmailEdit.setText(DriverEmail);
                    }
